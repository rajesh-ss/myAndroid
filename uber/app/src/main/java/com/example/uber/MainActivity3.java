...
// Apply the adapter to the spinner
    ...
    public void onclickbuttonMethod(View v) {
        ...
        if (selectedId == -1) {
            Toast.makeText(MainActivity3.this, "Nothing selected", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(MainActivity3.this, genderradioButton.getText(), Toast.LENGTH_SHORT).show();
        }
